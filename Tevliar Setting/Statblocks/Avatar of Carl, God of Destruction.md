...
- name: Unpredictable Destruction.
  desc: "At the start of the Avatar's turn, roll a d6. The Avatar gains a random destructive effect for that turn: <br> 1. Explosive Leap. The Avatar can move an additional 30 ft., leaving behind a trail of fire that deals 14 (4d6) fire damage to any creatures that start or end their turn in the fire. The fire extinguishes after 1 minute. <br> Rage of the Flame. The Avatar deals an additional 10 fire damage on all attacks. <br> 3. Flame Shield. Any creature that hits the Avatar with a melee attack takes 16 (3d10) fire damage. <br> 4. Wildfire Pulse. The Avatar releases a burst of flame, dealing 27 (6d8) fire damage to all creatures within 20 feet. <br> 5. "
actions: 
- name: 
  desc: 
- name: 
